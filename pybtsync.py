...
class BTSync():
    ...
    def add_folder(self, folder_path, secret=None, selective_sync=0):
        ...
        self._request_function('add_folder', arguments = arguments)
        
    def remove_folder(self, secret):
        arguments = 'secret=' + secret
        self._request_function('remove_folder', arguments = arguments)
    ...
    def get_secrets(self, secret): #encryption enables always
        arguments = 'secret=' + secret
        arguments = arguments + '&type=encryption'
...
class BTSync_process():
    def __init__(self, api_key,
        ...
        time.sleep(5) #TODO: find a better way to find if it is up
